...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  mutations: {
    ...
    UPDATE_TASK: function UPDATE_TASK(state, updatedTask) {
      ...
      if (index !== -1) {
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].set(state.tasks, index, updatedTask);
      }
    },
  ...
  actions: {
    ...
    updateTask: function updateTask(_ref2, task) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/tasks/".concat(task.id), task).then(function (response) {
    ...
    deleteTask: function deleteTask(_ref3, taskId) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/tasks/".concat(taskId)).then(function () {
...
var render = function () {
  ...
  return _c("div", { staticClass: "container mt-5" }, [
    _c("h1", { staticClass: "text-center mb-4" }, [_vm._v("Task List")]),
    _vm._v(" "),
    _c(
      "ul",
      ...
      _vm._l(_vm.tasks, function (task) {
        return _c(
          ...
          [
            _c("div", [
              _c("h5", { staticClass: "mb-1" }, [_vm._v(_vm._s(task.title))]),
              _vm._v(" "),
              ...
              _c("small", { staticClass: "text-muted" }, [
                _vm._v("Assigned to: " + _vm._s(task.user)),
              ]),
            ]),
            _vm._v(" "),
            _c("div", [
      ...
      [
        ...
        _c("div", { staticClass: "form-group" }, [
          _c("input", {
            ...
            staticClass: "form-control",
            attrs: { value: "1", placeholder: "Assigned User", required: "" },
            domProps: { value: _vm.newTask.user },
            on: {
              input: function ($event) {
                if ($event.target.composing) {
                  return
